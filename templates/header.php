    ...
    <div class="container">
      <div class="row">
        ...
        <nav class="header-nav hidden">
          <ul>
            <li><a href="index.php" class="header-nav-link">
            ...
            <li class="none"><a href="workshop.php" class="header-nav-link">
            ...
            <li><a href="used_cars.php" class="header-nav-link">
            ...
            <li><a href="about.php" class="header-nav-link">
                <!-- <img src="assets/images/icons/about.svg" alt="about icon"> -->
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
            ...
            <li><a href="contact.php" class="header-nav-link">
        ...
        <button type="button" class="menu">
          <img src="assets/images/icons/burger-menu.svg" alt="burger menu icon">
        </button>
      </div>
    </div>
  </header>

      ...
      <div class="row">
        ...
        <nav class="header-nav hidden">
          <ul>
            ...
            <li>
              <a href="http://localhost:8888/used_cars.php" class="header-nav-link">
            ...
            <!-- <li>
              <a href="http://localhost:8888/about.php" class="header-nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
            ...
            <li>
              <a href="http://localhost:8888/contact.php" class="header-nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
